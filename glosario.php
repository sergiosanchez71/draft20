...
$terminos = [
    ...
    ['id' => 'tematica', 'nombre' => 'Temática', 'def' => 'La lista de 20 ítems sobre la que se juega la partida (fútbol, anime, comida, streamers…). Draft 20 tiene 69 temáticas.', 'enlace' => '/#tematicas'],
