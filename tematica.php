...
$jsJugar = '(function () {'
    ...
    . '  b.disabled = true;'
    . '  var nombre = ""; var dinero = 20; try { nombre = localStorage.getItem("draft20_nombre") || ""; var dg = localStorage.getItem("draft20_dinero"); if (dg === "10" || dg === "30") dinero = parseInt(dg, 10); } catch (e) {}'
    . '  fetch("/api/crear_sala.php", { method: "POST", headers: { "Content-Type": "application/json" },'
    . '   credentials: "same-origin",'
    . '   body: JSON.stringify({ tematica: tema, nombre: nombre, dinero_inicial: dinero }) })'
