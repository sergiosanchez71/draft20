...
$tematicas = ['hamburguesa', 'zombies', 'peliculas', 'vacaciones', 'futbol', 'videojuegos', 'poderes', 'pareja', 'atraco'];
?><!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    ...
    <script>window.__TEMATICAS = <?= json_encode($tematicas, JSON_UNESCAPED_UNICODE) ?>;</script>
