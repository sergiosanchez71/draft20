...
// 5) Sala de bot → no se registra aquí.
$s5 = sala_base([$it(10)], [$it(1)], ['bot_slot' => 1]);
registrar_partida_humana($s5, $log);
check(empty($s5['log_humana']), 'bot no se registra aquí');
...
check(count($lineas) === 3, '3 líneas en el log (3 finales, sin abandono/bot/doble)');
