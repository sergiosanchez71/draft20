...
- **Favicon**: `favicon.ico` (16/32/48) y `icons/icon-48.png` / `icon-96.png` se generan desde `icon-512.png` con `npm run gen:icons`. Se declaran con **rutas absolutas** (`asset()` devuelve `/…`) para que también funcionen en las URLs bonitas (`/tematica/<id>`, `/guia/<slug>`), y en tamaños **múltiplos de 48** que son los que Google usa para el favicon en los resultados de búsqueda.
